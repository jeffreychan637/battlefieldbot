...
#define PWM_B_CY_TCPWM_V2                    (CYIPBLOCK_m0s8tcpwm_VERSION == 2u)
#define PWM_B_CY_TCPWM_4000                  (CY_PSOC4_4000)
...
#define PWM_B_QUAD_AUTO_START                (0lu)
...
/* Trigger modes */
#define PWM_B_TRIG_RISING                    ((uint32)PWM_B__TRIG_RISING)
#define PWM_B_TRIG_FALLING                   ((uint32)PWM_B__TRIG_FALLING)
#define PWM_B_TRIG_BOTH                      ((uint32)PWM_B__TRIG_BOTH)
#define PWM_B_TRIG_LEVEL                     ((uint32)PWM_B__TRIG_LEVEL)

/* Interrupt mask */
#define PWM_B_INTR_MASK_TC                   ((uint32)PWM_B__INTR_MASK_TC)
#define PWM_B_INTR_MASK_CC_MATCH             ((uint32)PWM_B__INTR_MASK_CC_MATCH)
...
#define PWM_B_PWM_MODE_ASYM                  (PWM_B_CC_MATCH_INVERT       |   \
                                                         PWM_B_OVERLOW_SET           |   \
                                                         PWM_B_UNDERFLOW_CLEAR)

#if (PWM_B_CY_TCPWM_V2)
...
#define PWM_B_QUAD_SIGNALS_MODES                                                             \
...
#define PWM_B_PWM_SIGNALS_MODES                                                              \
...
#define PWM_B_TIMER_SIGNALS_MODES                                                            \
...
#define PWM_B_TIMER_UPDOWN_CNT_USED                                                          \
                ((PWM_B__COUNT_UPDOWN0 == PWM_B_TC_COUNTER_MODE)                  ||\
                 (PWM_B__COUNT_UPDOWN1 == PWM_B_TC_COUNTER_MODE))

#define PWM_B_PWM_UPDOWN_CNT_USED                                                            \
                ((PWM_B__CENTER == PWM_B_PWM_ALIGN)                               ||\
                 (PWM_B__ASYMMETRIC == PWM_B_PWM_ALIGN))               
        
#define PWM_B_PWM_PR_INIT_VALUE              (1u)
#define PWM_B_QUAD_PERIOD_INIT_VALUE         (0x8000u)
