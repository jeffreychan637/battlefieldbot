...
void PWM_B_Enable(void)
{
    ...
    #if (PWM_B__QUAD == PWM_B_CONFIG)
        #if (0u != PWM_B_QUAD_AUTO_START)
            PWM_B_TriggerCommand(PWM_B_MASK, PWM_B_CMD_RELOAD);
        #endif /* (0u != PWM_B_QUAD_AUTO_START) */
    #endif  /* (PWM_B__QUAD == PWM_B_CONFIG) */
}
...
*   Values:
*     - PWM_B_CMD_CAPTURE    - Trigger Capture/Switch command
*     - PWM_B_CMD_RELOAD     - Trigger Reload/Index command
*     - PWM_B_CMD_STOP       - Trigger Stop/Kill command
*     - PWM_B_CMD_START      - Trigger Start/phiB command
*
* Return:
*  None
*
