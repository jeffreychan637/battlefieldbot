...
#define PWM_R_CY_TCPWM_V2                    (CYIPBLOCK_m0s8tcpwm_VERSION == 2u)
#define PWM_R_CY_TCPWM_4000                  (CY_PSOC4_4000)
...
#define PWM_R_QUAD_AUTO_START                (0lu)
...
/* Trigger modes */
#define PWM_R_TRIG_RISING                    ((uint32)PWM_R__TRIG_RISING)
#define PWM_R_TRIG_FALLING                   ((uint32)PWM_R__TRIG_FALLING)
#define PWM_R_TRIG_BOTH                      ((uint32)PWM_R__TRIG_BOTH)
#define PWM_R_TRIG_LEVEL                     ((uint32)PWM_R__TRIG_LEVEL)

/* Interrupt mask */
#define PWM_R_INTR_MASK_TC                   ((uint32)PWM_R__INTR_MASK_TC)
#define PWM_R_INTR_MASK_CC_MATCH             ((uint32)PWM_R__INTR_MASK_CC_MATCH)
...
#define PWM_R_PWM_MODE_ASYM                  (PWM_R_CC_MATCH_INVERT       |   \
                                                         PWM_R_OVERLOW_SET           |   \
                                                         PWM_R_UNDERFLOW_CLEAR)

#if (PWM_R_CY_TCPWM_V2)
...
#define PWM_R_QUAD_SIGNALS_MODES                                                             \
...
#define PWM_R_PWM_SIGNALS_MODES                                                              \
...
#define PWM_R_TIMER_SIGNALS_MODES                                                            \
...
#define PWM_R_TIMER_UPDOWN_CNT_USED                                                          \
                ((PWM_R__COUNT_UPDOWN0 == PWM_R_TC_COUNTER_MODE)                  ||\
                 (PWM_R__COUNT_UPDOWN1 == PWM_R_TC_COUNTER_MODE))

#define PWM_R_PWM_UPDOWN_CNT_USED                                                            \
                ((PWM_R__CENTER == PWM_R_PWM_ALIGN)                               ||\
                 (PWM_R__ASYMMETRIC == PWM_R_PWM_ALIGN))               
        
#define PWM_R_PWM_PR_INIT_VALUE              (1u)
#define PWM_R_QUAD_PERIOD_INIT_VALUE         (0x8000u)
