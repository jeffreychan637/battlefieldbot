...
#define PWM_G_CY_TCPWM_V2                    (CYIPBLOCK_m0s8tcpwm_VERSION == 2u)
#define PWM_G_CY_TCPWM_4000                  (CY_PSOC4_4000)
...
#define PWM_G_QUAD_AUTO_START                (0lu)
...
/* Trigger modes */
#define PWM_G_TRIG_RISING                    ((uint32)PWM_G__TRIG_RISING)
#define PWM_G_TRIG_FALLING                   ((uint32)PWM_G__TRIG_FALLING)
#define PWM_G_TRIG_BOTH                      ((uint32)PWM_G__TRIG_BOTH)
#define PWM_G_TRIG_LEVEL                     ((uint32)PWM_G__TRIG_LEVEL)

/* Interrupt mask */
#define PWM_G_INTR_MASK_TC                   ((uint32)PWM_G__INTR_MASK_TC)
#define PWM_G_INTR_MASK_CC_MATCH             ((uint32)PWM_G__INTR_MASK_CC_MATCH)
...
#define PWM_G_PWM_MODE_ASYM                  (PWM_G_CC_MATCH_INVERT       |   \
                                                         PWM_G_OVERLOW_SET           |   \
                                                         PWM_G_UNDERFLOW_CLEAR)

#if (PWM_G_CY_TCPWM_V2)
...
#define PWM_G_QUAD_SIGNALS_MODES                                                             \
...
#define PWM_G_PWM_SIGNALS_MODES                                                              \
...
#define PWM_G_TIMER_SIGNALS_MODES                                                            \
...
#define PWM_G_TIMER_UPDOWN_CNT_USED                                                          \
                ((PWM_G__COUNT_UPDOWN0 == PWM_G_TC_COUNTER_MODE)                  ||\
                 (PWM_G__COUNT_UPDOWN1 == PWM_G_TC_COUNTER_MODE))

#define PWM_G_PWM_UPDOWN_CNT_USED                                                            \
                ((PWM_G__CENTER == PWM_G_PWM_ALIGN)                               ||\
                 (PWM_G__ASYMMETRIC == PWM_G_PWM_ALIGN))               
        
#define PWM_G_PWM_PR_INIT_VALUE              (1u)
#define PWM_G_QUAD_PERIOD_INIT_VALUE         (0x8000u)
