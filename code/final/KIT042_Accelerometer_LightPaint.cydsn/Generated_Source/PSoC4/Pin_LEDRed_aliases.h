...
#define Pin_LEDRed_0_PS		(Pin_LEDRed__0__PS)
#define Pin_LEDRed_0_PC		(Pin_LEDRed__0__PC)
#define Pin_LEDRed_0_DR		(Pin_LEDRed__0__DR)
#define Pin_LEDRed_0_SHIFT	(Pin_LEDRed__0__SHIFT)
#define Pin_LEDRed_0_INTR	((uint16)((uint16)0x0003u << (Pin_LEDRed__0__SHIFT*2u)))
